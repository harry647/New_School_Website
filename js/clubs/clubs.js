// /js/clubs/clubs.js
// Fully dynamic – loads clubs from /data/clubs/clubs.json and events.json
...
Promise.all([
  fetch("/data/clubs/clubs.json").then(r => r.ok ? r.json() : Promise.reject("clubs.json missing")),
  fetch("/data/clubs/events.json").then(r => r.ok ? r.json() : [])
